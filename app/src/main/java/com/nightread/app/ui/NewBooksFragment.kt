...
class NewBooksFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.activity_new_books, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        rvNewBooks = view.findViewById(R.id.rvNewBooks)
        rvNewBooks.layoutManager = GridLayoutManager(requireContext(), 3)
    ...
    private fun loadNewBooks() {
        viewLifecycleOwner.lifecycleScope.launch {
            ...
            val newBooks = kotlinx.coroutines.withContext(kotlinx.coroutines.Dispatchers.IO) {
