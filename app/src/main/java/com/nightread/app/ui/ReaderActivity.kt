...
class ReaderActivity : FragmentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        lifecycleScope.launchWhenStarted {
            com.nightread.app.data.SettingsManager.settingsChanged.collect {
                ...
                val fontSize = com.nightread.app.data.SettingsManager.getFontSize(this@ReaderActivity)
                val fontFamily = com.nightread.app.data.SettingsManager.getFontFamily(this@ReaderActivity)
                val fontWeight = com.nightread.app.data.SettingsManager.getFontWeight(this@ReaderActivity)
                val lineSpacingMultiplier = com.nightread.app.data.SettingsManager.getLineSpacing(this@ReaderActivity)
    ...
    private fun setupLayout() {
        ...
        setContentView(com.nightread.app.R.layout.activity_reading)

        val root = findViewById<FrameLayout>(com.nightread.app.R.id.rootContainer)
        viewPager = findViewById(com.nightread.app.R.id.viewPager)
        progressBar = findViewById(com.nightread.app.R.id.progressBar)
        topBar = findViewById(com.nightread.app.R.id.topBar)
        bottomBar = findViewById(com.nightread.app.R.id.bottomBar)
        progressText = findViewById(com.nightread.app.R.id.progressText)
        titleText = findViewById(com.nightread.app.R.id.titleText)
        seekBar = findViewById(com.nightread.app.R.id.seekBar)
        readingProgressBar = findViewById(com.nightread.app.R.id.readingProgressBar)

        backButtonView = findViewById(com.nightread.app.R.id.backButtonView)
        settingsBtn = findViewById(com.nightread.app.R.id.settingsBtn)
    ...
    private val hudHideRunnable = Runnable {
        findViewById<View>(com.nightread.app.R.id.brightnessHud)?.visibility = View.GONE
    }

    private fun showBrightnessFeedback(percentage: Int) {
        val hud = findViewById<TextView>(com.nightread.app.R.id.brightnessHud) ?: return
    ...
    private fun toggleNightMode() {
        val currentTheme = com.nightread.app.data.SettingsManager.getTheme(this)
        if (currentTheme == "dark") {
            val prevTheme = com.nightread.app.data.SettingsManager.getPreviousTheme(this)
            com.nightread.app.data.SettingsManager.setTheme(this, prevTheme)
            Toast.makeText(this, "Восстановлена тема: ${themeNameRussian(prevTheme)}", Toast.LENGTH_SHORT).show()
        } else {
            com.nightread.app.data.SettingsManager.setTheme(this, "dark")
    ...
    private fun applyThemeColors() {
        val themeName = com.nightread.app.data.SettingsManager.getTheme(this)
    ...
    private suspend fun splitContentToPages(content: String, measuredWidth: Int, measuredHeight: Int): List<String> {
        ...
        val fontSize = com.nightread.app.data.SettingsManager.getFontSize(this)
        val fontFamily = com.nightread.app.data.SettingsManager.getFontFamily(this)
        val fontWeight = com.nightread.app.data.SettingsManager.getFontWeight(this)
        val lineSpacingMultiplier = com.nightread.app.data.SettingsManager.getLineSpacing(this)
