...
# I will replace the triggerSync method with a new flow:
# btnSyncNow.setOnClickListener { showStatsAndSync() }
...
content = content.replace("private fun triggerSync() {", new_trigger + "\n    private fun oldTriggerSync() {")
content = content.replace("triggerSync()", "showStatsAndSync()")
